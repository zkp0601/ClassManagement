					...
					<ul class="nav ace-nav">
						...
						<li class="green">
							...
							<ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-close">
								...
								<li>
									<a href="#">
										<img src='<c:url value="/img/avatars/avatar3.jpg"></c:url>' class="msg-photo" alt="Susan's Avatar" />
										<span class="msg-body">
											<span class="msg-title">
								...
								<li>
									<a href="#">
										<img src='<c:url value="/img/avatars/avatar4.jpg"></c:url>' class="msg-photo" alt="Bob's Avatar" />
										<span class="msg-body">
											<span class="msg-title">

											...
											<div class="widget-box transparent">
												...
												<div class="widget-body">
													<div class="widget-main">
														<textarea style="width:100%; font-weight:bold; color:black; resize:none; background-color:#f2f6f9;" disabled="disabled" id="content_editable_${notice_item._notice.notice_id}">${notice_item._notice.content}</textarea>
